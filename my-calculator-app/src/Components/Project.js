  ...
  return (
    <div className="p-4 bg-white">
      ...
      <div className="flex flex-col items-center mb-4 relative group">
        ...
        {showQR && (
          <img
            src="/assets/qr-code.png" // Поместите файл в public/assets/
            alt="QR: ftarasow.ru"
      ...
      <p className="mt-4 text-xs text-gray-500 text-center border-t pt-2">
        © 2025 Фёдор Тарасов | Москва | <a href="https://ftarasow.ru" target="_blank" className="underline hover:text-blue-600">ftarasow.ru</a><br />
